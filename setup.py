...
class get_eigen_include(object):
    ...
    def __str__(self) -> str:
        ...
        git.Repo.clone_from(
            "https://gitlab.com/libeigen/eigen.git", target_dir, branch="3.4.0"
        )
...
ext2 = Pybind11Extension(
    name="davies", sources=["src/mssm/src/cpp/davies.cpp"], cxx_std=14
)

ext3 = Pybind11Extension(
    name="dChol",
...
ext4 = Pybind11Extension(
    name="mcmc",
    sources=["src/mssm/src/cpp/mcmc.cpp"],
    include_dirs=[get_eigen_include()],
    cxx_std=14,
)
