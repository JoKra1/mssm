...
class Test_model_comparisons1:
    ...
    def test_comp1(self):
        assert round(self.unbiased_cor_result['Res. DOF'],ndigits=3) == 1.004
    
    def test_comp2(self):
        assert round(self.unbiased_cor_result['aic_diff'],ndigits=3) == 1.983
    ...
    def test_comp5(self):
        assert round(self.cor_result['Res. DOF'],ndigits=3) == 1.002
    
    def test_comp6(self):
        assert round(self.cor_result['aic_diff'],ndigits=3) == 1.983
...
class Test_model_comparison2:
    ...
    def test_comp1(self):
        assert round(self.cor_result['Res. DOF'],ndigits=3) == 1.04
    
    def test_comp2(self):
        assert round(self.cor_result['aic_diff'],ndigits=3) == 1.299
    
    def test_comp3(self):
        assert round(self.uncor_result['Res. DOF'],ndigits=3) == 1.105
    
    def test_comp4(self):
        assert round(self.uncor_result['aic_diff'],ndigits=3) == 1.428