...
class Test_shared:
    ...
    def test_GAMsigma(self):
        _, sigma = self.model.get_pars()
        np.testing.assert_allclose(
            sigma, 1.7122411065941043, atol=min(max_atol, 0), rtol=min(max_rtol, 0.1)
        )
    ...
    def test_GAMlam(self):
        ...
        np.testing.assert_allclose(
            lam,
            np.array([14.629496491885678, 0.013963339658823426, 10000000.0]),
            atol=min(max_atol, 0),
    ...
    def test_GAMreml(self):
        reml = self.model.get_reml()
        np.testing.assert_allclose(
            reml, -3735.1473943934952, atol=min(max_atol, 0), rtol=min(max_rtol, 0.1)
        )

    def test_GAMllk(self):
        llk = self.model.get_llk(False)
        np.testing.assert_allclose(
            llk, -3704.808316377433, atol=min(max_atol, 0), rtol=min(max_rtol, 0.1)
        )
    ...
    def test_ps(self):
        ...
        np.testing.assert_allclose(
            ps,
            np.array([0.33824014901410493, 0.0, 0.0, 0.19845583521152332]),
            atol=min(max_atol, 0),
            rtol=min(max_rtol, 0.5),
        )
