...
class Test_shared_pen:
    ...
    def test_GAMedf(self):
        np.testing.assert_allclose(self.model.edf,102.77768526577066,atol=min(max_atol,0),rtol=min(max_rtol,0.1)) 

    def test_GAMcoef(self):
        coef = self.model.coef
        np.testing.assert_allclose(coef,np.array([[2.16073927], [-0.30751271], [0.00804397], [0.41931178], [0.62922032],
                                                [0.50293013], [0.47044998], [-0.07389187], [-0.41076222], [-0.67140238],
                                                [-0.90969171], [-0.42080664], [-0.13732844], [0.13881862], [0.50286417],
                                                [1.03348977], [1.67936417], [2.30239745], [2.96343188], [0.01206083],
                                                [0.00334539], [-0.04759724], [0.13968849], [0.0422996], [0.02889479],
                                                [0.15241367], [0.05386427], [-0.05021066], [-0.4007482], [0.00208111],
                                                [-0.00333144], [-0.08993651], [-0.1073239], [0.10086104], [-0.14108587],
                                                [0.29031209], [-0.11065822], [0.00393929], [0.15100357], [0.00589482],
                                                [-0.00687222], [0.00495268], [-0.00020914], [0.03737691], [0.0555292],
                                                [-0.03449138], [-0.00976472], [-0.0460496], [0.10512797], [0.00991475],
                                                [0.00372289], [-0.0501952], [-0.12234681], [0.05175467], [0.09775063],
                                                [0.0179073], [0.0760515], [0.04346028], [0.47216763], [-0.00666565],
                                                [0.00018417], [0.0274873], [-0.04046905], [0.05844833], [-0.15203497],
                                                [-0.00012814], [-0.05010687], [-0.16939737], [-1.52963785], [0.01177969],
                                                [-0.01249832], [0.00922872], [0.0637496], [0.05786684], [0.06533718],
                                                [-0.00313293], [0.18963943], [0.24170958], [0.35441666], [-0.01336941],
                                                [-0.0074242], [-0.02388593], [-0.01773195], [-0.00752282], [0.05325788],
                                                [-0.28002771], [0.02829423], [-0.11873485], [-0.71771164], [0.00389207],
                                                [5.14388861e-05], [0.1261879], [0.00593148], [0.04264027], [-0.28599986],
                                                [-0.10094715], [-0.20846605], [-0.06373695], [0.13628551], [-0.01359949],
                                                [-0.00042743], [-0.04150794], [-0.08027701], [-0.02462083], [0.14259451],
                                                [0.0524536], [0.06897401], [-0.14875727], [0.02826317], [-0.00600536],
                                                [-0.0017441], [0.00132468], [0.03543415], [0.03920896], [0.18296249],
                                                [-0.09240643], [0.10042856], [0.01040981], [0.17968612], [-0.00404791],
                                                [0.00236925], [0.03087416], [0.00997209], [0.13750696], [0.10289532],
                                                [0.19144873], [0.05877519], [-0.06183513], [0.25571316], [-0.01153248],
                                                [0.02113275], [-0.0515599], [0.05829071], [-0.0907264], [-0.13871154],
                                                [0.07059182], [-0.13652051], [-0.13836005], [0.38681673], [-0.00108427],
                                                [0.00278971], [-0.0348846], [-0.11449822], [-0.08334592], [-0.08163137],
                                                [-0.16017335], [-0.00662091], [0.0044768], [0.18545606], [0.00486271],
                                                [-0.00414665], [0.04082684], [0.10303688], [-0.03331398], [-0.18193427],
                                                [-0.04733249], [0.0910428], [0.01575008], [0.52304813], [0.01156381],
                                                [-0.01083438], [0.09266063], [-0.0174312], [-0.06832857], [0.17006488],
                                                [-0.0798846], [0.02286562], [0.06835218], [0.13080953], [-0.00484208],
                                                [0.01334249], [-0.03279982], [-0.04569875], [-0.1179811], [0.14126647],
                                                [0.11497014], [-0.20124141], [0.25121358], [0.31016978], [-0.00423847],
                                                [-0.00652227], [-0.02483061], [-0.03680119], [-0.09674717], [-0.15096416],
                                                [-0.02690759], [-0.24157873], [0.14560173], [-0.29431386], [0.00992868],
                                                [-0.00390957], [-0.09044788], [0.04534676], [-0.15290567], [0.05058026],
                                                [0.19791474], [0.35775433], [0.07161996], [-0.5192041], [-0.01392384],
                                                [0.00109519], [0.03344526], [-0.04458681], [0.05610657], [-0.00352594],
                                                [-0.25489843], [-0.02150696], [-0.05828736], [0.24265163], [0.32934218],
                                                [-0.40279217], [0.79291944], [1.10560544], [0.25250519], [0.53906606],
                                                [0.44550243], [0.25445301], [-0.27622053], [-0.72065483], [0.04653594],
                                                [0.01143272], [-0.01000409], [-0.02870777], [-0.04345144], [-0.05704806],
                                                [-0.06786803], [-0.06543554], [-0.06456724]]),atol=min(max_atol,0.5),rtol=min(max_rtol,0.5)) 

    def test_GAMlam(self):
        lam = np.array([p.lam for p in self.model.overall_penalties])
        np.testing.assert_allclose(lam,np.array([31.222081138940332, 4.071165297330471, 3.9187652112113875, 11307.85547736765, 2.358734759947485]),atol=min(max_atol,0),rtol=min(max_rtol,2.5)) 

    def test_GAMreml(self):
        reml = self.model.get_reml()
        np.testing.assert_allclose(reml,-15526.867512177605,atol=min(max_atol,0),rtol=min(max_rtol,0.1)) 

    def test_GAMllk(self):
        llk = self.model.get_llk(False)
        np.testing.assert_allclose(llk,-15331.745250625594,atol=min(max_atol,0),rtol=min(max_rtol,0.1)) 

    def test_edf1(self):
        compute_bias_corrected_edf(self.model,overwrite=False)
        edf1 = np.array([edf1 for edf1 in self.model.term_edf1])
        np.testing.assert_allclose(edf1,np.array([6.713831972418086, 4.921128087309552, 102.24427710377597, 6.914787187470902, 1.3584941787931564]),atol=min(max_atol,0),rtol=min(max_rtol,1.5)) 
    ...
    def test_TRs(self):
        ...
        for par in range(len(self.model.formulas)):
            ...
            Trs.extend(pTrs)
        np.testing.assert_allclose(Trs,np.array([38.39621398859056, 2835.761588753815, 243.2047117086251, 3.7791188495195702]),atol=min(max_atol,0),rtol=min(max_rtol,1.5))
    ...
    def test_lcp(self):
        ...
        assert np.allclose(self.model.family.lcp(y,*self.model.mus),
...
class Test_shared_pen2:
    ...
    def test_GAMedf(self):
        np.testing.assert_allclose(self.model.edf,130.72218261728594,atol=min(max_atol,0),rtol=min(max_rtol,0.1)) 

                        [0.02670412], [0.26363358], [-0.34735499], [-0.05134187], [0.54313027],
                        [-0.40113299], [-0.04004757], [-0.00057945], [0.17824561], [-0.03508846],
                        [-0.01729312], [0.12189015], [-0.28875698], [-0.24148508], [0.09187039],
                        [0.23762201], [-0.41020104], [0.51091602], [0.27002684], [-0.01299843],
                        [0.00409057], [-0.09368029], [0.22793119], [-0.08466904], [0.1219294],
                        [-0.02438717], [-0.46775333], [0.30516531], [-0.61783438], [0.01973811],
                        [0.01366687], [-0.4212647], [0.07558249], [-0.37178917], [0.89664008],
                        [0.51782389], [0.76799581], [0.22655926], [-1.23745417], [0.03803879],
                        [0.01819071], [0.00376931], [0.18267585], [-0.25871975], [-0.32445422],
                        [-0.35652889], [-0.17535872], [-0.11950472], [0.56891088], [0.3021903],
                        [-0.44229743], [0.70869284], [0.8898239], [0.30911353], [0.34759764],
                        [0.32849039], [-0.0591877], [-0.25116141], [-0.26208804], [-0.02282505],
                        [-0.00788459], [0.0014938], [0.01083016], [0.0193732], [0.02798971],
                        [0.03547143], [0.03660794], [0.03841562]]),atol=min(max_atol,1),rtol=min(max_rtol,0.5)) 

    def test_GAMlam(self):
        lam = np.array([p.lam for p in self.model.overall_penalties])
        np.testing.assert_allclose(lam,np.array([3.9614527961398274, 0.8717540995086903, 1.0050277835190533, 10000000.0, 3.0248416458589253]),atol=min(max_atol,0),rtol=min(max_rtol,2.5)) 

    def test_GAMreml(self):
        reml = self.model.get_reml()
        np.testing.assert_allclose(reml,-8886.226185427402,atol=min(max_atol,0),rtol=min(max_rtol,0.1)) 

    def test_GAMllk(self):
        llk = self.model.get_llk(False)
        np.testing.assert_allclose(llk,-8606.027341258703,atol=min(max_atol,0),rtol=min(max_rtol,0.1)) 

    def test_edf1(self):
        compute_bias_corrected_edf(self.model,overwrite=False)
        edf1 = np.array([edf1 for edf1 in self.model.term_edf1])
        np.testing.assert_allclose(edf1,np.array([5.621712839293441, 6.497582544082489, 128.47016448878225, 7.430870523057176, 1.0015037147259365]),atol=min(max_atol,0),rtol=min(max_rtol,1.5)) 
    ...
    def test_ps(self):
        ...
        for par in range(len(self.model.formulas)):
            pps, _ = approx_smooth_p_values(self.model,par=par)
            ps.extend(pps)
        np.testing.assert_allclose(ps,np.array([3.574312402943036e-06, 0.0, 0.0, 0.09119187436952991]),atol=min(max_atol,0),rtol=min(max_rtol,0.5)) 
    ...
    def test_TRs(self):
        ...
        for par in range(len(self.model.formulas)):
            _, pTrs = approx_smooth_p_values(self.model,par=par)
            Trs.extend(pTrs)
        np.testing.assert_allclose(Trs,np.array([38.36237880945953, 9463.441910146503, 712.2431495413452, 2.856138998529643]),atol=min(max_atol,0),rtol=min(max_rtol,1.5))
