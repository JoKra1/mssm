...
section, which includes installation instructions. Then you should complete the `Tutorial`, in which you will familiarize yourself with the syntax of ``mssm`` and the `mssmViz <https://github.com/JoKra1/mssm_tutorials>`_. ``mssmViz``
